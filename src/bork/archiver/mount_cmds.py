...
class MountMixIn:
    ...
    def build_parser_mount_umount(self, subparsers, common_parser, mid_common_parser):
        ...
        self._define_bork_mount(subparser)
    ...
    def build_parser_borkfs(self, parser):
        assert parser.prog == "borkfs"
        parser.description = self.do_mount.__doc__
        parser.epilog = "For more information, see bork mount --help."
        parser.formatter_class = argparse.RawDescriptionHelpFormatter
        parser.help = "mount repository"
        self._define_bork_mount(parser)
        return parser

    def _define_bork_mount(self, parser):
