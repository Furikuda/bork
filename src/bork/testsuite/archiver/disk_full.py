...
dd if=/dev/zero of=/tmp/bork-disk bs=16M count=1
mkfs.ext4 /tmp/bork-disk
mkdir /tmp/bork-mount
sudo mount /tmp/bork-disk /tmp/bork-mount
    ...
    with environment_variable(BORG_CHECK_I_KNOW_WHAT_I_AM_DOING="YES"):
        ...
        for j in range(100):
            ...
            try:
                ...
                # free some space so we can expect bork to be able to work normally:
