...
class DebugMixIn:
    ...
    def do_debug_convert_profile(self, args):
        """convert Bork profile to Python profile"""
        import marshal
    ...
    def build_parser_debug(self, subparsers, common_parser, mid_common_parser):
        ...
        debug_convert_profile_epilog = process_epilog(
            """
        Convert a Bork profile to a Python cProfile compatible profile.
        """
        )
        subparser = debug_parsers.add_parser(
            "convert-profile",
            ...
            formatter_class=argparse.RawDescriptionHelpFormatter,
            help="convert Bork profile to Python profile (debug)",
        )
        subparser.set_defaults(func=self.do_debug_convert_profile)
        subparser.add_argument("input", metavar="INPUT", type=argparse.FileType("rb"), help="Bork profile")
