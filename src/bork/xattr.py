...
# TODO: If that's the case then we can make Bork fakeroot-xattr-compatible on these as well.
...
def is_enabled(path=None):
    ...
    with tempfile.NamedTemporaryFile(dir=path, prefix="bork-tmp") as f:
        fd = f.fileno()
