...
class CryptoTestCase(BaseTestCase):
    ...
    def test_AES256_CTR_HMAC_SHA256(self):
        # this tests the layout as in bork < 1.2 (1 type byte, no aad)
        mac_key = b"Y" * 32
        enc_key = b"X" * 32
        iv = 0
        data = b"foo" * 10
...
def test_repo_key_detect_does_not_raise_integrity_error(getpass, monkeypatch):
    """https://github.com/furikuda/bork/pull/6469#discussion_r832670411

    This is a regression test for a bug I introduced and fixed:

    Traceback (most recent call last):
      File "/home/user/bork-master/src/bork/testsuite/crypto.py", line 384, in test_repo_key_detect_does_not_raise_integrity_error
        RepoKey.detect(repository, manifest_data=None)
      File "/home/user/bork-master/src/bork/crypto/key.py", line 402, in detect
        if not key.load(target, passphrase):
      File "/home/user/bork-master/src/bork/crypto/key.py", line 654, in load
        success = self._load(key_data, passphrase)
      File "/home/user/bork-master/src/bork/crypto/key.py", line 418, in _load
        data = self.decrypt_key_file(cdata, passphrase)
      File "/home/user/bork-master/src/bork/crypto/key.py", line 444, in decrypt_key_file
        return self.decrypt_key_file_argon2(encrypted_key, passphrase)
      File "/home/user/bork-master/src/bork/crypto/key.py", line 470, in decrypt_key_file_argon2
        return ae_cipher.decrypt(encrypted_key.data)
      File "src/bork/crypto/low_level.pyx", line 302, in bork.crypto.low_level.AES256_CTR_BASE.decrypt
        self.mac_verify(<const unsigned char *> idata.buf+aoffset, alen,
      File "src/bork/crypto/low_level.pyx", line 382, in bork.crypto.low_level.AES256_CTR_HMAC_SHA256.mac_verify
        raise IntegrityError('MAC Authentication failed')
    bork.crypto.low_level.IntegrityError: MAC Authentication failed
