...
class TestPopenWithErrorHandling:
    ...
    @pytest.mark.skipif(
        shutil.which("bork-foobar-test-notexist"), reason='"bork-foobar-test-notexist" binary exists (somehow?)'
    )
    def test_not_found(self):
        proc = popen_with_error_handling("bork-foobar-test-notexist 1234")
        assert proc is None
