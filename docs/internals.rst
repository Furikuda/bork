...
Bork uses a low-level, key-value store, the :ref:`repository`, and
...
.. figure:: internals/structure.png
    ...
    Layers in Bork. On the very top commands are implemented, using
    ...
    the sole trust boundary in Bork.
