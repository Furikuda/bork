...
class IntegrityCheckedFile(FileLikeWrapper):
    ...
    def hash_filename(self, filename=None):
        ...
        # In Bork the name itself encodes the context (eg. index.N, cache, files),
        ...
        # While Bork does not use anything except ASCII in these file names, it's important to use
