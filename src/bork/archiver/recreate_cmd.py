...
class RecreateMixIn:
    ...
    def build_parser_recreate(self, subparsers, common_parser, mid_common_parser):
        ...
        and PATH have the exact same semantics as in "bork create", but they only check
        ...
        **USE WITH CAUTION.**
        ...
        subparser.add_argument(
            ...
            dest="output_filter",
            action=Highlander,
            help="only display items with the given status characters (listed in bork create --help)",
        )
