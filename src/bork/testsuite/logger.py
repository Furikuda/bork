...
def test_setup_logging(io_logger):
    ...
    assert io_logger.getvalue() == "bork.testsuite.logger: hello world\n"


def test_multiple_loggers(io_logger):
    logger = logging.getLogger(__name__)
    logger.info("hello world 1")
    assert io_logger.getvalue() == "bork.testsuite.logger: hello world 1\n"
    logger = logging.getLogger("bork.testsuite.logger")
    logger.info("hello world 2")
    assert io_logger.getvalue() == "bork.testsuite.logger: hello world 1\nbork.testsuite.logger: hello world 2\n"
    io_logger.truncate(0)
    io_logger.seek(0)
    logger = logging.getLogger("bork.testsuite.logger")
    logger.info("hello world 2")
    assert io_logger.getvalue() == "bork.testsuite.logger: hello world 2\n"
