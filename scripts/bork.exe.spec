# -*- mode: python -*-
# this pyinstaller spec file is used to build bork binaries on posix platforms
...
if is_win32:
    ...
    hiddenimports = ['bork.platform.posix', 'pkg_resources.py2_warn', ]

block_cipher = None

a = Analysis([os.path.join(basepath, 'src', 'bork', '__main__.py'), ],
             pathex=[basepath, ],
             binaries=[],
             datas=[
                (os.path.join(basepath, 'src', 'bork', 'paperkey.html'), 'bork'),
             ],
